...
#path = os.environ.get('PROJECT_PATH', r'C:\Users\Администратор\PycharmProjects\airflow_hw_3')
# dt = datetime.now().strftime("%Y%m%d%H%M")
# model_filename = f'{path}/data/models/cars_pipe_{dt}.pkl'
path = os.environ.get('PROJECT_PATH', os.path.dirname(os.path.dirname(__file__)))
path_models = f'{path}/data/models'
...
def pipeline() -> None:
    ...
    model_filename = f'{path_models}/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
